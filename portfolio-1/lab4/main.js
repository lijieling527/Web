...
imgMain.onload=function(){
    ...
    // 人變大ctx.drawImage(imgMain,350,0,80,130,200,0,gridLength,gridLength*3);
};
...
//                 if(mapArray[x][y]==1){
//                     // ctx.drawImage(imgMountain,32,65,32,32,y*gridLength,x*gridLength,gridLength,gridLength);
//                     context.drawImage(images.imgMountain,32,65,32,32,y*gridLength,x*gridLength,gridLength,gridLength);
//                 }else if(mapArray[x][y]==3){
//                     // ctx.drawImage(imgEnemy,7,40,104,135,y*gridLength,x*gridLength,gridLength,gridLength);
//                     context.drawImage(images.imgEnemy,7,40,104,135,y*gridLength,x*gridLength,gridLength,gridLength);
//                 }
//             }
//         }
//     }
